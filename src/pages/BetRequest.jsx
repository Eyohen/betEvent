...
const BetRequest = () => {
  ...
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-[#2C5C4B]">Thank you for Registering!!!</h2>
    <h2 class="mt-10 text-center text-2xl font-medium leading-9 tracking-tight text-gray-900">Interested in the BetTribes Competition?</h2>
  </div>
...
<Link to={"/home"}>
      <div className='mt-4'>
        <button type="submit" class="flex w-full justify-center rounded-md bg-[#2C5C4B] px-3 py-1.5 text-md font-semibold leading-6 text-[#FFC000] shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 h-12">Submit Id</button>
      </div>
      </Link>
    </form>
